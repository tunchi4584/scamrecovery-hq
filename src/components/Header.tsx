      ...
      <header className={`bg-background/95 backdrop-blur-md border-b sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex justify-between items-center py-6">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-2xl font-heading font-bold text-foreground group-hover:text-accent transition-colors duration-200">
              ScamRecovery Pro
            </span>
          </Link>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden py-6 border-t border-border/50 bg-background/98 backdrop-blur-md shadow-lg">
